...
| 020 | SA LP issuer disclosures | Each Schedule 13D/13G newer than the latest 13F sets that issuer's position from its filing date; layers accumulate until the next 13F. Reported aggregates as filed (warrants included); Forms 3/4 not layered. | Final |
