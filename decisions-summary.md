...
| 008 | Search Console validation | Validate only issues whose examples actually resolve. Never validate "Page with redirect" — those 301s are intentional and it fails by design (tried 2026-05-05, failed 2026-05-09). | Final |
